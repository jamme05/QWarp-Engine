...
namespace qw
{
	...
	public:
		...
		explicit operator cVector< 2, T>() { return cVector< 2, T>(*this); }
		explicit operator cVector< 4, T>() { return cVector< 4, T>(*this); }

		template <typename T2>
		explicit operator cVector< 2, T2>() { return cVector< 2, T2>(*this); }
		template <typename T2>
		explicit operator cVector< 3, T2>() { return cVector< 3, T2>(*this); } // Infinite loop?
		template <typename T2>
		explicit operator cVector< 4, T2>() { return cVector< 4, T2>(*this); }
