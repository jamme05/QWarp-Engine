...
namespace qw
{
	...
	public:
		...
		void render_with( qw::Object::Components::cCamera& _camera, Graphics::cRender_context& _context, const bool _swap = true );

		static auto get_active_context( void ){ return m_active_context; }
		static auto get_actual_buffer( void ){ return m_actual_buffer; }
	...
	private:
		...
		static sce::Agc::Core::Buffer* m_actual_buffer;

		static Graphics::cRender_context* m_active_context;

		std::vector< cShared_ptr< cScene > > m_scenes;
	};
} // qw::
