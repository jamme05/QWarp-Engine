...
{
	cCamera::cCamera( const Graphics::sViewport& _viewport, const Graphics::sScissor& _scissors, const sCameraSettings& _settings, const eType _type )
	...
	void cCamera::calculateProjectionMatrix( void )
	{
