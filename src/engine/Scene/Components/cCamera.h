...
namespace qw::Object::Components
{
	...
	public:
		...
		cCamera( const Graphics::sViewport& _viewport, const Graphics::sScissor& _scissors, const sCameraSettings& _settings, const eType _type );
